...
class Customer extends MX_Controller
{
    ...
    public function bdtask_form($id = null)
    {
        ...
        if ($this->form_validation->run() === true) {
            ...
            if (empty($this->input->post('customer_id', TRUE))) {
                ...
                (customer_id, customer_name, customer_mobile, customer_email, email_address, contact, phone, fax, city, state, zip, country, customer_address, address2, status, 
                create_by,chassisno,mortorno,model,registrationno,vehiclepurchasedate) 
                VALUES 
                ('{$this->input->post('customer_id', TRUE)}',
                 ...
                 '{$this->session->userdata('id')}',
                  '{$this->input->post('chassisno', TRUE)}',
                   '{$this->input->post('mortorno', TRUE)}',
                   '{$this->input->post('model', TRUE)}',
                   '{$this->input->post('registrationno', TRUE)}',
                   '{$this->input->post('vehiclepurchasedate', TRUE)}'
                );";
    ...
    SET 
        ...
        chassisno=  '{$this->input->post('chassisno', TRUE)}',
         mortorno=  '{$this->input->post('mortorno', TRUE)}',
         model=    '{$this->input->post('model', TRUE)}',
        registrationno= '{$this->input->post('registrationno', TRUE)}',
        vehiclepurchasedate='{$this->input->post('vehiclepurchasedate', TRUE)}'
            WHERE 
