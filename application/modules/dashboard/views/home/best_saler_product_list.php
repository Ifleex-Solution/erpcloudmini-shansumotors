                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Best of Sale Products for Last 365 days</h4>
                            <p class="text-right">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="printableArea">
                            <div class="text-center">
                                ...
                                <h3><?php echo $company_info2[0]['company_name']?>  </h3>
                                <h4 ><?php echo $company_info2[0]['address']?> </h4>
                              
                                <h4> <?php echo display('print_date') ?>: <?php echo date("d/m/Y h:i:s"); ?> </h4>
                                
                                    <strong>Best of Sale Products for Last 365 days</strong>
                            </div>
