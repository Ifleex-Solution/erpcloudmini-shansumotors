...
class Invoice_model extends CI_Model
{
    ...
    public function invoice_posentry($incremented_id)
    {
    ...
    public function sale($postData = null, $type2,$branchid)
    {
    ...
    public function quotation($postData = null, $type2,$branchid)
    {
